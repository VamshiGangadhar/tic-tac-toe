...
const Gameboard = () => {
    ...
    return(
        <>
            ...
            <Board>
                <div>
                    <button ref={block_1} className="game_box" onClick={() => on_going_game(1,block_1)}></button>
                    <button ref={block_2} className="game_box" onClick={() => on_going_game(2,block_2)}></button>
                    <button ref={block_3} className="game_box" onClick={() => on_going_game(3,block_3)}></button>
                </div>
                <div>
                    <button ref={block_4} className="game_box" onClick={() => on_going_game(4,block_4)}></button>
                    <button ref={block_5} className="game_box" onClick={() => on_going_game(5,block_5)}></button>
                    <button ref={block_6} className="game_box" onClick={() => on_going_game(6,block_6)}></button>
                </div>
                <div>
                    <button ref={block_7} className="game_box" onClick={() => on_going_game(7,block_7)}></button>
                    <button ref={block_8} className="game_box" onClick={() => on_going_game(8,block_8)}></button>
                    <button ref={block_9} className="game_box" onClick={() => on_going_game(9,block_9)}></button>
                </div>
